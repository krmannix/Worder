...
public class WordApplet_V2 extends JApplet implements TextListener {
  ...
  ArrayList<Word> wordlistBritish;
  ArrayList<Word> wordlistAmerican;
  CreateWordList makeWordListBritish;
  CreateWordList makeWordListAmerican;
  ...
  int numLimitLetters, numLimitSyl;
  ...
  private void setUpWordList() {
    ...
    // the ArrayList
    try {
      makeWordListBritish = new CreateWordList();
      makeWordListAmerican = new CreateWordList("American");
    } catch (Exception e) { 
      System.out.println("IO Exception making word list");
    }
    wordlistBritish = makeWordListBritish.getWordList();
    wordlistAmerican = makeWordListAmerican.getWordList();
